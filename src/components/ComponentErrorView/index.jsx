...
const ComponentErrorView = ({
  children,
  text,
  where = undefined,
  setReturnToHome = undefined
}) => {
  const { seconds, handleRedirectToHome } = useComponentErrorView(
    where,
    setReturnToHome
  );

  return (
    <WrapComponentErrorView className='WrapComponentErrorView my-5'>
      <div className='col col-12 col-sm-7 rounded text-center'>{children}</div>
      <div className='col col-12 col-sm-8 col-md-4 my-3 my-md-0 d-flex flex-column justify-content-center align-items-center'>
        ...
        <CustomButton
          buttonClass='mt-2 col col-7 col-sm-8 col-md-6'
          text='Ir a home'
